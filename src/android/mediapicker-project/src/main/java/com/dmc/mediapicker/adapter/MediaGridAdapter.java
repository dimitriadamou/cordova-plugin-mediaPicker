package com.dmc.mediapicker.adapter;
...
import com.dmc.mediapicker.PickerConfig;
import com.dmc.mediapicker.R;
import com.dmc.mediapicker.entity.Media;
import com.dmc.mediapicker.utils.FileUtils;
import com.dmc.mediapicker.utils.ScreenUtils;
...
public class MediaGridAdapter extends RecyclerView.Adapter<MediaGridAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.dmc_media_view_item, viewGroup, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.check_image.setImageDrawable(isSelect >= 0 ? ContextCompat.getDrawable(context, R.drawable.dmc_btn_selected) : ContextCompat.getDrawable(context, R.drawable.dmc_btn_unselected));
            ...
            public void onClick(View v) {
                ...
                if (selectMedias.size() >= maxSelect && isSelect < 0) {
                    ...
                    if (media.size > maxSize) {
                        ...
                        holder.check_image.setImageDrawable(isSelect >= 0 ? ContextCompat.getDrawable(context, R.drawable.dmc_btn_unselected) : ContextCompat.getDrawable(context, R.drawable.dmc_btn_selected));

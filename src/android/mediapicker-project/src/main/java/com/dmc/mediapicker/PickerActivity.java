...
import com.dmc.mediapicker.adapter.FolderAdapter;
import com.dmc.mediapicker.adapter.MediaGridAdapter;
import com.dmc.mediapicker.adapter.SpacingDecoration;
import com.dmc.mediapicker.data.DataCallback;
import com.dmc.mediapicker.data.ImageLoader;
import com.dmc.mediapicker.data.MediaLoader;
import com.dmc.mediapicker.data.VideoLoader;
...
public class PickerActivity extends Activity implements DataCallback, View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dmc_main);
